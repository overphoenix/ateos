import factoryValidator from "./factory_validator";
import PoolOptions from "./pool_options";
import ResourceRequest from "./resource_request";
import ResourceLoan from "./recource_loan";
import PooledResource from "./pooled_resource";
...
export default class Pool extends ateos.EventEmitter {
  ...
  constructor(Evictor, Deque, PriorityQueue, factory, options) {
    ...
    /**
         ...
         */
    this._evictionIterator = this._availableObjects[Symbol.iterator]();
  ...
  acquire(priority) {
    ...
    this._waitingClientsQueue.push(resourceRequest, priority);
    this._dispense();
