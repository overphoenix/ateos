 ...
 * @return the cipher.
 */
const createCipher = function (key, bits, encrypt) {
  let _finish = false; let _input = null; let _output = null; let _iv = null;
  let mixRound; let mashRound;
  let i; let j; const K = [];
