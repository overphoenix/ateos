...
const nockScope = Symbol.for("ateos.shani.util.nock.nockScope");
const nockScopeKey = Symbol.for("ateos.shani.util.nock.nockScopeKey");
const nockScopeOptions = Symbol.for("ateos.shani.util.nock.nockScopeOptions");
