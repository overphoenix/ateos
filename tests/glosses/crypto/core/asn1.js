...
describe("asn1", () => {
    ...
    (function () {
        const _h2b = (str) => UTIL.hexToBytes(str.replace(/ /g, ""));

        const _add = (b, str) => {
            b.putBytes(_h2b(str));
        };

        const _asn1dump = (asn1) => {
            console.log(ASN1.prettyPrint(asn1));
            console.log(JSON.stringify(asn1, null, 2));
        };
        const _asn1TestOne = function (strict, throws, options) {
            options = options || {};
            ...
            const asn1assert = throws ? assert.throws : function (f) {
                f();
            };
            let asn1;
            let der;
        ...
        const _asn1Test = function (options) {
        ...
        it("should handle ASN.1 mutations", () => {
            _asn1Test({
                ...
                captured: {
                    ...
                    const expect = _h2b("03 09 00 30 06 02 01 02 02 01 03");
                    // compare
