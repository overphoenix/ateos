describe("math", "Decimal", "Decimal", function () {
    const {
        Decimal,
        assertEqualProps,
        assertEqual,
    ...
    const t = (coefficient, exponent, sign, n) => {
        assertEqualProps(coefficient, exponent, sign, new Decimal(n));
    };
    ...
    describe("base conversion", () => {
        const t = function (expected, n) {
            assertEqual(expected, new Decimal(n).valueOf());
        };
        ...
        it("random integers against Number.prototype.toString(base)", () => {
            for (let k, i = 0; i < 127; i++) {
                k = randInt();
    ...
    it("parsing", () => {
        ...
        tx(() => {
            new Decimal(new Date());
        }, "new Date");
        tx(() => {
            new Decimal(new RegExp());
        }, "new RegExp");
        tx(() => {
            new Decimal("");
