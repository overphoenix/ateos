...
describe("number", () => {
    ...
    describe("validate()", () => {
        ...
        it("should, when .required(), deny undefined", () => {
            ...
            Helper.validate(model.number().required(), [
        ...
        it("should return false for denied value", async () => {
            ...
            const text = model.number().invalid(50);
            const err = await assert.throws(async () => text.validate(50));
        ...
        it("should return true for allowed Infinity", () => {
            ...
            const t = model.number().allow(Infinity, -Infinity);
            Helper.validate(t, [
                [Infinity, true],
                [-Infinity, true]
            ]);
        ...
        it("converts an object string to a number", async () => {
            const config = { a: model.number() };
            const obj = { a: "123" };

            const value = await model.compile(config).validate(obj);
            expect(value.a).to.equal(123);
        });

        it("converts a string to a number", async () => {
            const value = await model.number().validate("1");
            expect(value).to.equal(1);
        });

        it("errors on null", async () => {
            const err = await assert.throws(async () => model.number().validate(null));
            expect(err.details).to.eql([{
                message: '"value" must be a number',
                path: [],
                type: "number.base",
        ...
        it("should handle combination of min and max", () => {
            ...
            const rule = model.number().min(8).max(10);
        ...
        it("should handle combination of min, max, and null allowed", () => {
            ...
            const rule = model.number().min(8).max(10).allow(null);
            Helper.validate(rule, [
                [1, false, null, {
                    message: '"value" must be larger than or equal to 8',
                    details: [{
        ...
        it("should handle combination of min and positive", () => {
            ...
            const rule = model.number().min(-3).positive();
            Helper.validate(rule, [
                [1, true],
                [-2, false, null, {
        ...
        it("should handle combination of max and positive", () => {
            ...
            const rule = model.number().max(5).positive();
            Helper.validate(rule, [
                [4, true],
                [-2, false, null, {
                    message: '"value" must be a positive number',
        ...
        it("should handle combination of min and negative", () => {
            ...
            const rule = model.number().min(-3).negative();
            Helper.validate(rule, [
                [4, false, null, {
        ...
        it("should handle combination of negative and positive", () => {
            ...
            const rule = model.number().negative().positive();
            Helper.validate(rule, [
                [4, false, null, {
                    message: '"value" must be a negative number',
                    details: [{
        ...
        it("should handle combination of negative and allow", () => {
            ...
            const rule = model.number().negative().allow(1);
            Helper.validate(rule, [
                [1, true],
                [-10, true],
                [8, false, null, {
        ...
        it("should handle combination of positive and allow", () => {
            ...
            const rule = model.number().positive().allow(-1);
            Helper.validate(rule, [
                [1, true],
                [-1, true],
                [8, true],
        ...
        it("should handle combination of positive, allow, and null allowed", () => {
            ...
            const rule = model.number().positive().allow(-1).allow(null);
            Helper.validate(rule, [
                [1, true],
                [-1, true],
                [8, true],
        ...
        it("should handle combination of negative, allow, and null allowed", () => {
            ...
            const rule = model.number().negative().allow(1).allow(null);
            Helper.validate(rule, [
                [1, true],
                [-10, true],
                [8, false, null, {
        ...
        it("should handle combination of positive, allow, null allowed, and invalid", () => {
            ...
            const rule = model.number().positive().allow(-1).allow(null).invalid(1);
            Helper.validate(rule, [
                [1, false, null, {
                    message: '"value" contains an invalid value',
                    details: [{
        ...
        it("should handle combination of negative, allow, null allowed, and invalid", () => {
            ...
            const rule = model.number().negative().allow(1).allow(null).invalid(-5);
            Helper.validate(rule, [
                [1, true],
                [-10, true],
                [-5, false, null, {
        ...
        it("should handle combination of min, max, and allow", () => {
            ...
            const rule = model.number().min(8).max(10).allow(1);
            Helper.validate(rule, [
                [1, true],
                [11, false, null, {
                    message: '"value" must be less than or equal to 10',
        ...
        it("should handle combination of min, max, allow, and null allowed", () => {
            ...
            const rule = model.number().min(8).max(10).allow(1).allow(null);
            Helper.validate(rule, [
                [1, true],
                [11, false, null, {
                    message: '"value" must be less than or equal to 10',
        ...
        it("should handle combination of min, max, allow, and invalid", () => {
            ...
            const rule = model.number().min(8).max(10).allow(1).invalid(9);
            Helper.validate(rule, [
                [1, true],
                [11, false, null, {
                    message: '"value" must be less than or equal to 10',
        ...
        it("should handle combination of min, max, allow, invalid, and null allowed", () => {
            ...
            const rule = model.number().min(8).max(10).allow(1).invalid(9).allow(null);
            Helper.validate(rule, [
                [1, true],
                [11, false, null, {
                    message: '"value" must be less than or equal to 10',
        ...
        it("should handle combination of min, max, and integer", () => {
            ...
            const rule = model.number().min(8).max(10).integer();
            Helper.validate(rule, [
                [1, false, null, {
                    message: '"value" must be larger than or equal to 8',
                    details: [{
        ...
        it("should handle combination of min, max, integer, and allow", () => {
            ...
            const rule = model.number().min(8).max(10).integer().allow(9.1);
            Helper.validate(rule, [
                [1, false, null, {
                    message: '"value" must be larger than or equal to 8',
                    details: [{
        ...
        it("should handle combination of min, max, integer, allow, and invalid", () => {
            ...
            const rule = model.number().min(8).max(10).integer().allow(9.1).invalid(8);
            Helper.validate(rule, [
                [1, false, null, {
                    message: '"value" must be larger than or equal to 8',
                    details: [{
        ...
        it("should handle combination of min, max, integer, allow, invalid, and null allowed", () => {
            ...
            const rule = model.number().min(8).max(10).integer().allow(9.1).invalid(8).allow(null);
            Helper.validate(rule, [
                [1, false, null, {
                    message: '"value" must be larger than or equal to 8',
                    details: [{
        ...
        it("should handle limiting the number of decimal places", () => {
            ...
            const rule = model.number().precision(1).options({ convert: false });
            Helper.validate(rule, [
                [1, true],
                [9.1, true],
                [9.21, false, null, {
        ...
        it("should handle combination of min, max, integer, allow, invalid, null allowed and precision", () => {
            ...
            const rule = model.number().min(8).max(10).integer().allow(9.1).invalid(8).allow(null).precision(1).options({ convert: false });
            Helper.validate(rule, [
                [1, false, null, {
                    message: '"value" must be larger than or equal to 8',
                    details: [{
        ...
        it("should handle combination of greater and less", () => {
            ...
            const rule = model.number().greater(5).less(10);
            Helper.validate(rule, [
                [0, false, null, {
        ...
        it("should handle combination of greater, less, and integer", () => {
            ...
            const rule = model.number().integer().greater(5).less(10);
            Helper.validate(rule, [
                [0, false, null, {
                    message: '"value" must be greater than 5',
                    details: [{
        ...
        it("should handle combination of greater, less, and null allowed", () => {
            ...
            const rule = model.number().greater(5).less(10).allow(null);
            Helper.validate(rule, [
                [0, false, null, {
                    message: '"value" must be greater than 5',
                    details: [{
        ...
        it("should handle combination of greater, less, invalid, and allow", () => {
            ...
            const rule = model.number().greater(5).less(10).invalid(6).allow(-3);
            Helper.validate(rule, [
                [0, false, null, {
                    message: '"value" must be greater than 5',
                    details: [{
    ...
    it("should instantiate separate copies on invocation", () => {
        const result1 = model.number().min(5);
        const result2 = model.number().max(5);
    ...
    it("should show resulting object with #valueOf", () => {
        ...
        const result = model.number().min(5);
    ...
    describe("error message", () => {
        ...
        it("should display correctly for int type", async () => {
            ...
            const t = model.number().integer();
            const err = await assert.throws(async () => model.compile(t).validate("1.1"));
    ...
    describe("min()", () => {
        ...
        it("supports 64bit numbers", async () => {
            ...
            const schema = model.number().min(1394035612500);
        ...
        it("accepts references as min value", () => {
            ...
            const schema = model.object({ a: model.number(), b: model.number().min(model.ref("a")) });
        ...
        it("accepts references as min value within a when", () => {
            ...
            const schema = model.object({
                ...
                c: model.number().required().when("a", {
                    is: model.number().min(model.ref("b")), // a >= b
        ...
        it("accepts context references as min value", () => {
            ...
            const schema = model.object({ b: model.number().min(model.ref("$a")) });
        ...
        it("errors if reference is not a number", () => {
            ...
            const schema = model.object({ a: model.string(), b: model.number().min(model.ref("a")) });
    ...
    describe("max()", () => {
        ...
        it("accepts references as max value", () => {
            ...
            const schema = model.object({ a: model.number(), b: model.number().max(model.ref("a")) });
        ...
        it("accepts context references as max value", () => {
            ...
            const schema = model.object({ b: model.number().max(model.ref("$a")) });
        ...
        it("errors if reference is not a number", () => {
            ...
            const schema = model.object({ a: model.string(), b: model.number().max(model.ref("a")) });
    ...
    describe("less()", () => {
        ...
        it("accepts references as less value", () => {
            ...
            const schema = model.object({ a: model.number(), b: model.number().less(model.ref("a")) });
        ...
        it("accepts context references as less value", () => {
            ...
            const schema = model.object({ b: model.number().less(model.ref("$a")) });
        ...
        it("errors if reference is not a number", () => {
            ...
            const schema = model.object({ a: model.string(), b: model.number().less(model.ref("a")) });
    ...
    describe("greater()", () => {
        ...
        it("throws when limit is not a number", () => {
            ...
            expect(() => {
                ...
                model.number().greater("a");
            }).to.throw("limit must be a number or reference");
        });

        it("accepts references as greater value", () => {

            const schema = model.object({ a: model.number(), b: model.number().greater(model.ref("a")) });
        ...
        it("accepts context references as greater value", () => {
            ...
            const schema = model.object({ b: model.number().greater(model.ref("$a")) });
        ...
        it("errors if reference is not a number", () => {
            ...
            const schema = model.object({ a: model.string(), b: model.number().greater(model.ref("a")) });
    ...
    describe("precision()", () => {
        ...
        it("converts numbers", () => {
            ...
            const rule = model.number().precision(4);
            Helper.validate(rule, [
                [1.5, true, null, 1.5],
    ...
    describe("describe()", () => {
        ...
        it("should describe a minimum of 0", () => {
            ...
            const schema = model.number().min(0);
    ...
    describe("multiple()", () => {
        ...
        it("should handle floats multiples correctly", () => {
            ...
            const schema = model.number().multiple(3.5);
            Helper.validate(schema, [
                [0, true], // 0 is a multiple of every integer
                [3.5, true],
                [3.6, false, null, {
        ...
        it("should handle references correctly", () => {
            ...
            const schema = model.object({ a: model.number(), b: model.number().multiple(ref) });
            Helper.validate(schema, [
                [{ a: 2, b: 32 }, true],
                [{ a: 43, b: 0 }, true],
                [{ a: 4, b: 25 }, false, null, {
        ...
        it("should handle references correctly within a when", () => {
            ...
            const schema = model.object({
                ...
                b: model.number().required(),
                c: model.number().required().when("a", {
                    is: model.number().multiple(model.ref("b")), // a % b === 0
                    then: model.number().valid(0)
                })
            });
        ...
        it("should handle non-number references correctly", () => {
            ...
            const schema = model.object({ a: model.string(), b: model.number().multiple(model.ref("a")) });
            Helper.validate(schema, [
        ...
        it("should handle context references correctly", () => {
            ...
            const ref = model.ref("$a");
            const schema = model.object({ b: model.number().multiple(ref) });
            Helper.validate(schema, [
    ...
    describe("port()", () => {
        ...
        it("should validate correctly", () => {
            ...
            const schema = model.object({ port: model.number().port() });
