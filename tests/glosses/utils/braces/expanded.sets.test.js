...
const equal = (pattern, expected) => {
    const actual = braces.expand(pattern);
    assert.deepEqual(actual.sort(), expected.sort());
};

describe("util", "braces", "expanded sets", () => {
    ...
    describe("escaping", () => {
        ...
        it("should escape closing braces when open is not defined", () => {
    ...
    describe("set expansion", () => {
        ...
        it("should support sequence braces with leading characters", () => {
            equal("/usr/{ucb/{ex,edit},lib/{ex,how_ex}}", ["/usr/lib/ex", "/usr/lib/how_ex", "/usr/ucb/edit", "/usr/ucb/ex"]);
            equal("ff{c,b,a}", ["ffa", "ffb", "ffc"]);
        });

        it("should support sequence braces with trailing characters", () => {
        ...
        it("should support nested sequence braces with trailing characters", () => {
