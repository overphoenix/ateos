describe("util", "iconv", "Test Turkish encodings", () => {
    ...
    encodings.forEach((encoding) => {
        ...
        describe(`${encoding.name}:`, () => {
            ...
            it("Try different variations of encoding", () => {
                encoding.variations.forEach((enc) => {
            ...
            it("Untranslatable chars are converted to defaultCharSingleByte", () => {
                const expected = encoding.strings.untranslatable.split("").map(() => {
