...
const docs = {
    empty_array: {
        ...
        text: '{"matzue": "松江", "asakusa": "浅草"}', events: [
            ["openobject", "matzue"],
        ...
        text: "{\"foo\": \"its \\\"as is\\\", \\\"yeah\", \"bar\": false}", events: [
            ["openobject", "foo"],
        ...
        text: '{"foo": true, "bar": false, "baz": null}', events: [
            ["openobject", "foo"],
        ...
        text: '{"foo": "bar and all\\\"", "bar": "its \\\"nice\\\""}', events: [
            ["openobject", "foo"],
        ...
        text: '["and you can\'t escape thi\s"]', events: [
            ["openarray", undefined],
        ...
        text: '[-9223372036854775808]', events: [
            ['openarray', undefined],
        ...
        text: '[0.1e2, 1e1, 3.141569, 10000000000000e-10]', events: [
            ['openarray', undefined],
