...
describe("Decimal128", () => {
     ...
     * @ignore
     */
    it("fromString invalid input", (done) => {
        expect(() => {
    ...
    it("fromString infinity input", (done) => {
