...
describe("datetime", "locale", "fr", () => {
    commonLocaleTests("fr");
    ...
    it("format ordinal", () => {
        ...
        assert.equal(ateos.datetime([2017, 0, 2]).format("Do"), "2", "2");
    ...
    it("fromNow", () => {
        assert.equal(ateos.datetime().add({ s: 30 }).fromNow(), "dans quelques secondes", "in a few seconds");
