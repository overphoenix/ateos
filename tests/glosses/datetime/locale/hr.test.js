...
describe("datetime", "locale", "hr", () => {
    commonLocaleTests("hr");

    beforeEach(() => {
        ateos.datetime.locale("hr");
    });

    it("parse", () => {
        const tests = "siječanj sij._veljača velj._ožujak ožu._travanj tra._svibanj svi._lipanj lip._srpanj srp._kolovoz kol._rujan ruj._listopad lis._studeni stu._prosinac pro.".split("_");
        let i;
    ...
    it("format month", () => {
        const expected = "siječanj sij._veljača velj._ožujak ožu._travanj tra._svibanj svi._lipanj lip._srpanj srp._kolovoz kol._rujan ruj._listopad lis._studeni stu._prosinac pro.".split("_");
        let i;
