...
describe("datetime", "locale", "pt-br", () => {
    ...
    it("suffix", () => {
        assert.equal(ateos.datetime(30000).from(0), "em poucos segundos", "prefix");
        assert.equal(ateos.datetime(0).from(30000), "poucos segundos atrás", "suffix");
    });
    ...
    it("calendar day", () => {
        ...
        assert.equal(ateos.datetime(a).calendar(), "Hoje às 12:00", "today at the same time");
    ...
    it("relative time threshold", () => {
        const rts = ateos.datetime();
        const rtsDefault = ateos.datetime.relativeTimeThreshold("ss");
        ...
        ateos.datetime.relativeTimeThreshold("ss", rtsDefault);
    });
});
