...
import { createPatch, createTwoFilesPatch, structuredPatch } from "../../../../lib/glosses/diff/patch/create";
...
describe("patch/create", () => {
    describe("#createPatch", () => {
        it("should handle files with the last line changed", () => {
        ...
        it('should output "no newline" at end of file message on new missing nl', () => {
        ...
        it('should output "no newline" at end of file message on old missing nl', () => {
            expect(createPatch("test", "line1\nline2\nline3\nline4", "line1\nline2\nline3\nline4\n", "header1", "header2")).to.equal(
                "Index: test\n"
                + "===================================================================\n"
                + "--- test\theader1\n"
        ...
        it('should output "no newline" at end of file message on both missing nl', () => {
        ...
        it('should output "no newline" at end of file message on context missing nl', () => {
        ...
        it('should output only one "no newline" at end of file message on empty file', () => {
            expect(createPatch("test", "", "line1\nline2\nline3\nline4", "header1", "header2")).to.equal(
                "Index: test\n"
                + "===================================================================\n"
                + "--- test\theader1\n"
        ...
        it("should not output no newline at end of file message when eof outside hunk", () => {
            expect(createPatch("test", "line11\nline2\nline3\nline4\nline4\nline4\nline4", "line1\nline2\nline3\nline4\nline4\nline4\nline4", "header1", "header2")).to.equal(
                "Index: test\n"
                + "===================================================================\n"
                + "--- test\theader1\n"
        ...
        it("should diff large content blocks", () => {
            let random = 42;
            ...
            const len = largeTest.length;
            let count = nextRandom() % 20;
            const removeBound = len - (count * 100);
            const logData = [];
            for (; count > 0; count--) {
                const removePos = nextRandom() % removeBound;
                const removeLength = 1 + nextRandom() % 100;
            ...
            const diffResult = diffWords(largeTest, largeNewValue);
            log(`diffResult length: ${diffResult.length}`);
            const removeCount = 0;
            const removeChanges = []; const addChanges = [];
        ...
        it("should generate a patch with default context size", () => {
        ...
        it("should generatea a patch with context size 0", () => {
            const expectedResult =
                "Index: testFileName\n"
                + "===================================================================\n"
                + "--- testFileName\tOld Header\n"
        ...
        it("should generate a patch with context size 2", () => {
            const expectedResult =
                "Index: testFileName\n"
                + "===================================================================\n"
                + "--- testFileName\tOld Header\n"
        ...
        it("should output headers only for identical files", () => {
            const expectedResult =
                "Index: testFileName\n"
                + "===================================================================\n"
                + "--- testFileName\tOld Header\n"
        ...
        it("should omit headers if undefined", () => {
            const expectedResult =
                "Index: testFileName\n"
                + "===================================================================\n"
                + "--- testFileName\n"
        ...
        it("should safely handle empty inputs", () => {
            const expectedResult =
                "Index: testFileName\n"
                + "===================================================================\n"
                + "--- testFileName\n"
        ...
        it("should omit index with multiple file names", () => {
            const expectedResult =
                "===================================================================\n"
                + "--- foo\n"
                + "+++ bar\n";
