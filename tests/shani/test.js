...
describe("Engine", () => {
    ...
    describe("hooks", () => {
        ...
        describe("beforeEach", () => {
            ...
            it("should emit event for before each hooks", async () => {
                ...
                describe("/", () => {
                    beforeEach("before each", ateos.noop);
        ...
        describe("afterEach", () => {
            ...
            it("should emit event for after each hooks", async () => {
                ...
                describe("/", () => {
                    afterEach("after each", ateos.noop);
    ...
    describe("multiple describe names", () => {
        ...
        it("should return the last block", () => {
            ...
            const c = describe("a", "b", "c", ateos.noop);
